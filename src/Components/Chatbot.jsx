...
const Chatbot = () => {
  ...
  return (
    <div className="flex flex-col h-screen max-w-2xl mx-auto bg-[#a5fcad] rounded-lg shadow-2xl overflow-hidden">
      ...
      <form onSubmit={handleSubmit} className="p-4 bg-white bg-opacity-90 border-t border-green-300">
  <div className="flex items-center">
    <input
      type="text"
      value={input}
      onChange={handleInputChange}
      className="flex-1 mr-2 p-2 text-sm border border-green-300 rounded-full focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-300"
      placeholder="Type your message..."
    />
    <button
      type="submit"
      className="bg-green-500 text-white text-sm w-16 h-8 rounded-full hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-300 flex items-center justify-center"
    >
      Send
    </button>
  </div>
